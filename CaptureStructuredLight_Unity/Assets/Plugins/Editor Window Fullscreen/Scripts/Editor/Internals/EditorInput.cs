...
namespace EditorWindowFullscreen
{
    ...
    public sealed class EditorInput : EditorWindow
    {
        ...
        internal static EditorInput inputWin;
        public static bool performedHotkeyActionThisUpdate = false;
        private EditorInput() { }
        ...
        public static string GetKeysDownString(List<KeyCode> keysDownList, EventModifiers modifiers)
        {
            ...
            {
                #if UNITY_EDITOR_OSX
                if (modifiers.MatchesFlag(EventModifiers.Shift)) keysDownString += "%"; //Cmd appears as Ctrl when Shift is held (Mac).
                #else
                keysDownString += "Ctrl+";
                #endif
        ...
        public static string GetKeyMenuItemString(KeyCode keyCode, EventModifiers modifiers)
        {
            ...
            if (!isNumericFkey) keysDownString = keysDownString.ToLower(); //Must be lowercase if not F key (Mac).
        ...
        {
            if (hotkey == KeyCode.None || hotkey2 == KeyCode.None) return false;
        ...
        private static void RefreshEvent()
        {
            ...
            inputWin.Repaint();
            performedHotkeyActionThisUpdate = false;
        }
...
#if UNITY_EDITOR_WIN && SYSTEM_INPUT_OVERRIDE
        ...
        private class SystemInput
        {
            ...
            public static KeyboardProc KeyHandler;
            ...
            [DllImport("user32.dll")]
            public static extern IntPtr SetWindowsHookEx(int idHook, KeyboardProc lpfn, IntPtr hMod, int dwThreadId);
        ...
        public class SystemInput
        {
            ...
            [DllImport("EWFMac")]
            public static extern NSPoint GetMousePosition();

            [DllImport("EWFMac")]
            public static extern void SetMousePosition(int x, int y, bool convertCoordinatesFromBottomOrigin);
        }
#else
