/*
Dual Camera Chessboard Stereo Calibration

Inputs:
- 2 web cams connected to the compupter
OR
-a Folder of numbered images and
-a number of how many images are there

Plus
-Information about the chessboard

This program will generate documents (YAML files) of the intrinsics and extrinsics of the stereo pair of cameras
...
// THIS VERSION IS FOR CHESSBOARDS ONLY
//big board -w=6 -h=5 -sl=0.05 -ml=0.037
//Real big board w = 10    h = 13   sl = .06
//Matt Actual Chessboard 3 7 .031
//Matt Book Chess 6 8 
namespace {
	const char* about =
	...
	const char* keys =
		...
		"{sl       |    .023   | Square side length (in meters) }"
